...
A daily puzzle hub to track, manage, and compare your daily Wordle-style games. View scores, maintain streaks, and compete on leaderboards — all in one place.

## Features

- **Game Dashboard:** Fully customizable dashboard to organize and prioritize your puzzle roster. Track completion of each game's daily puzzle at a glance.
- **Game Tracking via Share Text:** Quickly log results by pasting Wordle-style share text. The app parses score lines, emoji grids, and metadata to auto-fill scores, compute streaks, and update history.
- **Leaderboards & User Profiles:** Built-in leaderboards and per-user profiles let you compare progress, view highscores, and explore public activity and stats.
